<template>
  <div v-if="selectedRegion && selectedDepartment && selectedCity" class="grid lg:grid-cols-2 max-lg:grid-cols-1 gap-5">
    <div class="col bg-gray-100 shadow-lg rounded-lg p-7"
      ...
      <h2 class="font-bold font-amsterdam text-2xl text-slate-600 text-center mb-4">{{ producer.name }}</h2>
      <p>
      ...
      <p v-if="producer.site.includes('http')">
        <span class="font-bold text-lg">
          Site:
        </span>
        <a class="text-blue-600 underline" :href="producer.site" target="_blank">
          {{ producer.site }}
        </a>
      </p>
      <p>
        ...
        <a class="text-blue-600 underline" :href="'mailto:' + producer.email">
          {{ producer.email }}
        </a>
      </p>
      <p>
        ...
        <a class="underline" :href="'tel:' + producer.phone">
          {{ producer.phone }}
        </a>
      </p>
    </div>
