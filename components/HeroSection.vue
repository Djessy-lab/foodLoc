  ...
  <div class="bg-gradient-to-b from-blue-200 to-blue-100">
    <header class="flex items-center justify-between p-4">
      ...
      <nav>
        <ul class="flex space-x-4">
          <li v-if="userEmail">
            <a href="/products" class="text-blue-600">Notre annuaire</a>
          </li>
          ...
          <li v-if="userEmail">
            <button class="text-blue-600" @click.prevent="logout">Se déconnecter</button>
          </li>
        </ul>
      </nav>
    </header>
    <section class="text-center py-12">
      <h1 class="text-4xl font-extrabold text-gray-900">
        Connectez les Producteurs aux Consommateurs
      </h1>
      <p class="mt-4 text-lg text-gray-600">
        Découvrez les produits locaux directement auprès des producteurs de
        votre région.
      </p>
      ...
      <div v-if="!userEmail" class="mt-6">
        <button
          class="max-w-32 min-w-32 bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700"
        >
